...
require (
	...
	vimagination.zapto.org/tsserver v1.2.5
)
...
require (
	...
	github.com/docker/spdystream v0.5.1 // indirect
	...
	github.com/lindell/go-ordered-set v1.1.0 // indirect
	...
	vimagination.zapto.org/javascript v1.6.10 // indirect
)
